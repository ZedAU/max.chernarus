...
// ***************************************** SERVER INITIALIZATION *****************************************
	...
	// global functions       //rossco - moved to seperate script to be run from init
...
if (_track=="TRACK") then {
  deleteMarker _trackername;                  //rossco  -  delete to clean out markers and stop some doubleups
